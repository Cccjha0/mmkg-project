...
def main():
    train_path = str(PROJECT_ROOT / "data/datasets/openbg_img/raw/OpenBG-IMG_train.tsv")
    dev_path = str(PROJECT_ROOT / "data/datasets/openbg_img/raw/OpenBG-IMG_dev.tsv")
    test_path = str(PROJECT_ROOT / "data/datasets/openbg_img/raw/OpenBG-IMG_test.tsv")
    ...
    num_entities = torch.load(PROJECT_ROOT / "data/cache/openbg_img/text_emb.pt").shape[0]
